...
public class BadCredentialsListener implements ApplicationListener<AuthenticationFailureBadCredentialsEvent>,
    ...
    public void onApplicationEvent(AuthenticationFailureBadCredentialsEvent event) {
        ...
        if (bce.getException() instanceof UsernameNotFoundException) {
            publisher.publishEvent(new PrincipalNotFoundEvent(principal, details, IdentityZoneHolder.get()));
        }
        else {
            publisher.publishEvent(new PrincipalAuthenticationFailureEvent(principal, details, IdentityZoneHolder.get()));
        }
    }
