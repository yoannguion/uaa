...
public class PasswordChangeFailureEvent extends AbstractPasswordChangeEvent {
    ...
    public PasswordChangeFailureEvent(String message, UaaUser user, Authentication principal, IdentityZone identityZone) {
        super(message, user, principal, identityZone);
    }
