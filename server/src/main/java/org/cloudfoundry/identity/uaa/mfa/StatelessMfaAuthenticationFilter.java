      ...
      throws ServletException, IOException {
        ...
        try {
            if (isGrantTypeSupported(request.getParameter(GRANT_TYPE))) {
                ...
                if (provider != null) {
                    publishEvent(new MfaAuthenticationSuccessEvent(user, getAuthentication(), provider.getType().toValue(), IdentityZoneHolder.get()));
                }
            }
            ...
            UaaUser user = getUaaUser();
            publishEvent(new MfaAuthenticationFailureEvent(user, getAuthentication(), provider != null ? provider.getType().toValue() : "null", IdentityZoneHolder.get()));
