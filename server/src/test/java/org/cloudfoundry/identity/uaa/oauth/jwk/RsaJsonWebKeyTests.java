...
public class RsaJsonWebKeyTests {
    ...
    @Test
    public void newJsonWebKey_fails_whenNoProperties() {
        expectedException.expect(IllegalArgumentException.class);
        expectedException.expectMessage("kty field is required");
        new JsonWebKey(new HashMap<>());
    }

    @Test
    public void newJsonWebKey_expectsKty() {
        Map<String, Object> map = new HashMap<>();
        map.put("kty", "RSA");
        JsonWebKey jsonWebKey = new JsonWebKey(map);
        assertEquals("RSA", jsonWebKey.getKty().name());
    }
